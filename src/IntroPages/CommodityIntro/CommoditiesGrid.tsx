    ...
    catelog: [
      {
        ...
        brand: "Bharati Udhyam",
        material: "Stainless Steel",
        sub: `Used for Particle Seggregation of different Powders.
Has 4 outlets for different particle size.
Can be customized for multistage mesh size.`,
      },
      {
        image: process.env.PUBLIC_URL + "/6.4.webp",
        content: `Solvent Extraction Plant`,
        price: "₹25,000 / Piece",
        capacity: "2000 TPD",
        grade: "Semi-Automatic",
        type: "Customized",
      ...
      },
      {
        ...
        brand: "Bharati Udhyam",
        material: "Mild Steel & Stainless Steel",
        sub: `Centrifugal Blowers for Air Suction, Delivery, Exhaust, Vaccum, Flour Mills, Raymond Mills`,
      },
      {
        image: process.env.PUBLIC_URL + "/6.6.webp",
        content: `Basket Centrifuge Machine`,
        ...
        brand: "Bharati Udhyam",
        material: "Stainless Steel",
        sub: `Centrifugal dryer used to remove excess oil/water from namkeens, potato and banana chips, leaves and much more. It has a rotating basket in which the product which has to be dried is placed, after a spin for few minutes the product is dried, to completely dry out the material hot air can be used at the later half of the drying cycle.`,
      },
    ],
  },
];
